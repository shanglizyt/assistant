...
<body
	...
	<div align="center">
      ...
      <td width="339" height="458" align="center" valign="middle"  >
	    ...
	    <s:if test="food.imageurl!=null">
			<img src="<s:property value="food.imageurl" />" width="260px" height="350"/>
			</s:if>
			<s:else>
			<img src="images/nopic.jpg" width="260px" height="350"/>
			</s:else>
	    <%-- <img src="<s:property value="food.imageurl" />" /> --%>
	    </div><div id="pic_name"><span class="STYLE13">图片注释</span></div>
	        </div></td>
	  <td width="689" valign="top"  >
	  <p align="left"><span class="STYLE14">中文名：</span><span class="STYLE17"><s:property value="food.name" /></span></p>
          	
          <p align="left"><span class="STYLE14">特点：</span><span class="STYLE17"><s:property value="food.miaoshu" /></span></p>
          <p align="left"><span class="STYLE14">主要元素：</span><span class="STYLE17">
				<s:iterator value="food.elements.toArray()">
						<s:property value="name" />&nbsp;&nbsp;&nbsp;&nbsp;
						<s:property value="amount" />
							<s:property value="unit" />/<s:property value="standard" /><br>
				</s:iterator>
			</span></p>
          </td>
					  </tr>
