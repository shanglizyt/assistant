										...
										<td width="536" align="right" valign="middle">
											<div id="ssk" align="center" class="out-shadow">
												<form action="" method="post" name="form1" id="form1">
													<input name="textfield" type="text" class="ssk_kuang1"
			...
			<tr>
				<td height="464">
					<table>
						...
						<!-- neirong -->
						<tr>
							<td width="1038" height="458" valign="top"><div
									id="article_title">
									<span class="STYLE13"><s:property value="article.title" /></span>
									<hr align="left" width="100%" color="#CACA00" />
								</div>
								<div id="art_pic_bk">
									<div id="article_picture" class="kuang1">
										<div id="picture">
											<s:if test="article.imageurl!=null">
											<img src="<s:property value="article.imageurl" />" width="260px" height="350"/>
											</s:if>
											<s:else>
