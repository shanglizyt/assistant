												...
												<table>
													<tr>
														...
														<td colspan="4" width="55%" class="tocenter"><s:if
															...
															<s:else>
																<a href="Commen_zhiliaolist?page=1">第一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
																<a
																	href="Commen_zhiliaolist?page=<s:property value="%{pageBean.currentPage-1}"/>">上一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</s:else> <s:if
																test="%{pageBean.currentPage != pageBean.totalPage}">
																<a
																	href="Commen_zhiliaolist?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
																<a
																	href="Commen_zhiliaolist?page=<s:property value="pageBean.totalPage"/>">最后一页</a>
