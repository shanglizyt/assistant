		...
		<table width="1055" cellpadding="0" cellspacing="5" bgcolor="#FFFFFF">
			...
			<tr>
			  <td height="464">
					...
					<!-- neirong -->
						<tr>
      <td width="339" height="458" align="center" valign="middle"  >
	    <div id="dish_picture" class="kuang1"><div id="picture">
	    	<s:if test="dish.imageurl!=null">
			<img src="<s:property value="dish.imageurl" />" width="260px" height="350"/>
			</s:if>
			<s:else>
			<img src="images/nopic.jpg" width="260px" height="350"/>
			</s:else>
	    <%-- <img src="<s:property value="dish.imageurl" />" /> --%>
	    
	    </div><div id="pic_name"><span class="STYLE13">图片注释</span></div>
	        </div></td>
	  <td width="689" valign="top"  >
	  <p align="left"><span class="STYLE14">中文名：</span><span class="STYLE17"><s:property value="dish.name" /></span></p>
          	<p align="left"><span class="STYLE14">主要食材：</span><span class="STYLE17">
				<s:iterator value="dish.foods.toArray()">
					<a href="Commen_fooddetail?food_id=<s:property value="id"/>"> <s:property
							value="name" />
					</a>&nbsp;
				</s:iterator>
			</span></p>
          <p align="left"><span class="STYLE14">口味：</span><span class="STYLE17"><s:property value="dish.kouwei" /></span></p>
          <p align="left"><span class="STYLE14">特点：</span><span class="STYLE17"><s:property value="dish.miaoshu" /></span></p>
          </td>
					  </tr>
