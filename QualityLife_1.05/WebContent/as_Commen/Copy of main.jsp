		...
		<table width="1055" height="1600" cellpadding="0" cellspacing="5"
			...
			<tr>
				<td width="216" rowspan="3" valign="top"><div id="weibom"
					...
					<fieldset id="perblog" style="width: 210px" class="kuang">
						<legend align="left">
							<img src="images/HeadPortrait/touxiang1.jpg" width="23"
								height="23" /><span class="STYLE38">用户名</span>
						</legend>

						<span class="STYLE28" style="font size: 12px">此处为用户微博内容，此处为用户微博内容此处为用户微博内容</span>
					</fieldset>
					<fieldset id="perblog" style="width: 210px" class="kuang">
						<legend align="left">
							<img src="images/HeadPortrait/touxiang2.jpg" width="23"
								height="23" /><span class="STYLE38">用户名</span>
						</legend>
					...
					<fieldset id="perblog" style="width: 210px" class="kuang">
						<legend align="left">
							<img src="images/HeadPortrait/touxiang3.jpg" width="23"
								height="23" /><span class="STYLE38">用户名</span>
						</legend>
					...
					<fieldset id="perblog" style="width: 210px" class="kuang">
						<legend align="left">
							<img src="images/HeadPortrait/touxiang4.jpg" width="23"
								height="23" /><span class="STYLE38">用户名</span>
						</legend>
					...
					<fieldset id="perblog" style="width: 210px" class="kuang">
						<legend align="left">
							<img src="images/HeadPortrait/touxiang5.jpg" width="23"
								height="23" /><span class="STYLE38">用户名</span>
						</legend>
