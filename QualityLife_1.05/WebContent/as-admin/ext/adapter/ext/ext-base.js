		...
		.apply(
				...
				function() {
					...
					return {
						...
						num : function(d, c) {
							d = Number(d === null || typeof d == "boolean" ? NaN
									: d);
							return isNaN(d) ? c : d
						},
							...
							for ( var f = 0; f < d; f++) {
								...
								if (Ext.isArray(c)) {
									...
									if (c.length !== undefined && !c.substr) {
										g = g.concat(Array.prototype.slice
												.call(c, 0))
									} else {
										g.push(c)
									}
						...
						invoke : function(c, d) {
							var f = [], e = Array.prototype.slice.call(
									arguments, 2);
						...
						type : function(d) {
							...
							if (c == "object" && d.nodeName) {
								...
								case 1:
									return "element";
								case 3:
									return (/\S/).test(d.nodeValue) ? "textnode"
											: "whitespace"
								}
							}
	...
	(function() {
		...
		Ext.lib.Dom = {
			...
			getDocumentHeight : function() {
				return e(!d ? f.body.scrollHeight
						: f.documentElement.scrollHeight, this
						.getViewportHeight())
			},
			getDocumentWidth : function() {
				return e(!d ? f.body.scrollWidth
						: f.documentElement.scrollWidth, this
						.getViewportWidth())
			},
			getViewportHeight : function() {
				return Ext.isIE ? (Ext.isStrict ? f.documentElement.clientHeight
						: f.body.clientHeight)
						: self.innerHeight
			},
			getViewportWidth : function() {
				return !Ext.isStrict && !Ext.isOpera ? f.body.clientWidth
						: Ext.isIE ? f.documentElement.clientWidth
								: self.innerWidth
			},
			getY : function(h) {
				...
				Ext.each(q, function(Q, R, P) {
					if (Q && (M = K.getElementById(Q.id))) {
						if (!Q.checkReady || y || M.nextSibling
								|| (K && K.body)) {
							M = Q.override ? (Q.override === true ? Q.obj
									: Q.override) : M;
							Q.fn.call(M, Q.obj);
							q[R] = null
						} else {
		...
		var A = {
			...
			getRelatedTarget : function(L) {
				...
				return this.resolveTextNode(L.relatedTarget
						|| (L.type == J ? L.toElement
								: L.type == B ? L.fromElement : null))
			},
			getPageX : function(L) {
				return j(L, "X")
			},
	...
	Ext.lib.Ajax = function() {
		...
		function e(t, s, r, q) {
			return {
				tId : t,
				status : r ? -1 : 0,
				statusText : r ? "transaction aborted"
																	...
																	u += String
																			.format(
																					...
																					(B.hasAttribute ? B
																							.hasAttribute("value")
																							: B
																									.getAttributeNode("value").specified) ? B.value
																							: B.text)
																}
															})
										} else {
					...
					.apply(
							g.Motion.prototype,
							{
								...
								getAttr : function(o) {
									...
									return l.test(o) ? [ p.call(q, "left"),
											p.call(q, "top") ] : p.call(q, o)
								},
								doMethod : function(o, r, p) {
									var q = this;
									return l.test(o) ? g.Bezier.getPosition(
											q.runAttrs[o],
											q.method(q.curFrame, 0, 100,
													q.totalFrames) / 100)
											: n.doMethod.call(q, o, r, p)
								},
