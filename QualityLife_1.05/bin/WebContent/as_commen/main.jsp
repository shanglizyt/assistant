...
<div align="center">
  <table width="1062" height="1600" cellpadding="0" cellspacing="5"  bgcolor="#FFFFFF" >
    ...
    <tr>
      ...
      <span class="STYLE28" style="font size:12px">此处为用户微博内容，此处为用户微博内容此处为用户微博内容此处为用户微博内容</span>
	    ...
	    <fieldset id="perblog" style="width: 210px" class="kuang"> <legend align="left"><img src="images/HeadPortrait/touxiang2.jpg" width="23" height="23" /><span class="STYLE38">用户名</span></legend>
 
      <span class="STYLE28" style="font size:12px">此处为用户微博内容，此处为用户微博内容此处为用户微博内容此处为用户微博内容</span>
      </fieldset>
	    <fieldset id="perblog" style="width: 210px" class="kuang"> <legend align="left"><img src="images/HeadPortrait/touxiang3.jpg" width="23" height="23" /><span class="STYLE38">用户名</span></legend>
 
      <span class="STYLE28" style="font size:12px">此处为用户微博内容，此处为用户微博内容此处为用户微博内容此处为用户微博内容</span>
      </fieldset>
	    <fieldset id="perblog" style="width: 210px" class="kuang"> <legend align="left"><img src="images/HeadPortrait/touxiang4.jpg" width="23" height="23" /><span class="STYLE38">用户名</span></legend>
 
      <span class="STYLE28" style="font size:12px">此处为用户微博内容，此处为用户微博内容此处为用户微博内容此处为用户微博内容</span>
      </fieldset>
	    <fieldset id="perblog" style="width: 210px" class="kuang"> <legend align="left"><img src="images/HeadPortrait/touxiang5.jpg" width="23" height="23" /><span class="STYLE38">用户名</span></legend>
    ...
    <tr>
      <td colspan="6" rowspan="2" valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="490" align="center" valign="bottom"><div ><img src="images/treeball_2.png" width="100%" height="100%" border="0" usemap="#Map" />
              <map name="Map" id="Map">
                <s:if test="#userName==null">
 ...
 <textarea name="liuyan" cols="50" rows="4" class="STYLE14">留个言吧</textarea>
